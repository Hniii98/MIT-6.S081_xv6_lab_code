...
int main(int argc, char* argv[])
{
   ...
   6:	0800                	addi	s0,sp,16
    ...
    if(argc == 1)
   8:	4785                	li	a5,1
   a:	02f50d63          	beq	a0,a5,44 <main+0x44>
    {
   ...
   e:	4789                	li	a5,2
  10:	06a7d263          	bge	a5,a0,74 <main+0x74>
    {
        
        write(2, errMessage[1], strlen(errMessage[1]));
  14:	00001517          	auipc	a0,0x1
  18:	82c50513          	addi	a0,a0,-2004 # 840 <malloc+0x104>
  1c:	00000097          	auipc	ra,0x0
  20:	0bc080e7          	jalr	188(ra) # d8 <strlen>
  24:	0005061b          	sext.w	a2,a0
  28:	00001597          	auipc	a1,0x1
  2c:	81858593          	addi	a1,a1,-2024 # 840 <malloc+0x104>
  30:	4509                	li	a0,2
  32:	00000097          	auipc	ra,0x0
  36:	2f4080e7          	jalr	756(ra) # 326 <write>
        exit(1);
  3a:	4505                	li	a0,1
  3c:	00000097          	auipc	ra,0x0
  40:	2ca080e7          	jalr	714(ra) # 306 <exit>
    	write(2, errMessage[0], strlen(errMessage[0]));
  44:	00000517          	auipc	a0,0x0
  48:	7dc50513          	addi	a0,a0,2012 # 820 <malloc+0xe4>
  4c:	00000097          	auipc	ra,0x0
  50:	08c080e7          	jalr	140(ra) # d8 <strlen>
  54:	0005061b          	sext.w	a2,a0
  58:	00000597          	auipc	a1,0x0
  5c:	7c858593          	addi	a1,a1,1992 # 820 <malloc+0xe4>
  60:	4509                	li	a0,2
  62:	00000097          	auipc	ra,0x0
  66:	2c4080e7          	jalr	708(ra) # 326 <write>
        exit(1);
  6a:	4505                	li	a0,1
  6c:	00000097          	auipc	ra,0x0
  70:	29a080e7          	jalr	666(ra) # 306 <exit>
    }
   
    SleepTime = atoi(argv[1]);
  74:	6588                	ld	a0,8(a1)
  76:	00000097          	auipc	ra,0x0
  7a:	190080e7          	jalr	400(ra) # 206 <atoi>
    sleep(SleepTime);
