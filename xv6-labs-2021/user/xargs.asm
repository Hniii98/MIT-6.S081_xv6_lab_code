...
*/
  ...
  4e:	fff5879b          	addiw	a5,a1,-1
    }

    int pid;
    char buf[BUFF_SIZE]; // buf数组存放一行的输入
    p = buf; // p指向buf数组起始
  52:	cd040493          	addi	s1,s0,-816
  ...
  56:	00379a13          	slli	s4,a5,0x3
  5a:	fd040713          	addi	a4,s0,-48
  5e:	9a3a                	add	s4,s4,a4
            origin_argv[idx+1] = '\0'; // 原始参数的尾部加上终止符,在“hello too\0”下一个位置加上终止符
  60:	0017899b          	addiw	s3,a5,1
  64:	098e                	slli	s3,s3,0x3
  66:	99ba                	add	s3,s3,a4
    while(read(0, p, sizeof(char)) > 0)
  68:	4605                	li	a2,1
  6a:	85a6                	mv	a1,s1
  6c:	4501                	li	a0,0
  6e:	00000097          	auipc	ra,0x0
  72:	2f6080e7          	jalr	758(ra) # 364 <read>
  76:	04a05b63          	blez	a0,cc <main+0xcc>
        if(*p == '\n') // 读到换行符，一行输入中止，开始执行命令
  7a:	0004c703          	lbu	a4,0(s1)
  7e:	47a9                	li	a5,10
  80:	00f70663          	beq	a4,a5,8c <main+0x8c>
        ...
        {
            p++;
  84:	0485                	addi	s1,s1,1
  86:	b7cd                	j	68 <main+0x68>
    for(idx = 0; idx < argc - 1; idx++)
  88:	4781                	li	a5,0
  8a:	b7e1                	j	52 <main+0x52>
            *p = '\0'; // 相当于buf = "hello too\0";
  8c:	00048023          	sb	zero,0(s1)
            origin_argv[idx] = buf; // 将当前行的参数写入原始参数内,相当于把“hello too\0”写入bye后一个位置
  90:	cd040793          	addi	a5,s0,-816
  94:	f0fa3023          	sd	a5,-256(s4)
            origin_argv[idx+1] = '\0'; // 原始参数的尾部加上终止符,在“hello too\0”下一个位置加上终止符
  98:	f009b023          	sd	zero,-256(s3)
            pid = fork();
  9c:	00000097          	auipc	ra,0x0
  a0:	2a8080e7          	jalr	680(ra) # 344 <fork>
            if(pid == 0) //子进程
  a4:	c919                	beqz	a0,ba <main+0xba>
            else if(pid > 0) //父进程
  a6:	fca051e3          	blez	a0,68 <main+0x68>
                wait(0);
  aa:	4501                	li	a0,0
  ac:	00000097          	auipc	ra,0x0
  b0:	2a8080e7          	jalr	680(ra) # 354 <wait>
                p = buf; //执行完命令继续将p指向buf初始位置，读取下一行
  b4:	cd040493          	addi	s1,s0,-816
  b8:	bf45                	j	68 <main+0x68>
                exec(argv[1], origin_argv); //将 bye hello too作为参数执行echo命令 
  ba:	ed040593          	addi	a1,s0,-304
  be:	00893503          	ld	a0,8(s2)
  c2:	00000097          	auipc	ra,0x0
  c6:	2c2080e7          	jalr	706(ra) # 384 <exec>
  ca:	bf79                	j	68 <main+0x68>
        }
    }
    exit(0);
  cc:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 402:	f6e080e7          	jalr	-146(ra) # 36c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 434:	44050513          	addi	a0,a0,1088 # 870 <digits>
 438:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 500:	374b8b93          	addi	s7,s7,884 # 870 <digits>
 ...
 640:	22c90913          	addi	s2,s2,556 # 868 <malloc+0xe6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 708:	1847b783          	ld	a5,388(a5) # 888 <freep>
 ...
 736:	00e6ea63          	bltu	a3,a4,74a <free+0x50>
{
 ...
 778:	10f73a23          	sd	a5,276(a4) # 888 <freep>
}
 77c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7aa:	0e253503          	ld	a0,226(a0) # 888 <freep>
 ...
 7d2:	0ba90913          	addi	s2,s2,186 # 888 <freep>
  if(p == (char*)-1)
 7d6:	5afd                	li	s5,-1
 7d8:	a88d                	j	84a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7da:	00000797          	auipc	a5,0x0
 7de:	0b678793          	addi	a5,a5,182 # 890 <base>
 7e2:	00000717          	auipc	a4,0x0
 7e6:	0af73323          	sd	a5,166(a4) # 888 <freep>
 7ea:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 80c:	08a73023          	sd	a0,128(a4) # 888 <freep>
      return (void*)(p + 1);
 ...
 85a:	b7e080e7          	jalr	-1154(ra) # 3d4 <sbrk>
  if(p == (char*)-1)
