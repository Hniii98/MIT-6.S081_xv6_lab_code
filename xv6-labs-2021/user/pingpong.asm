...
int main()
{
  ...
  10:	fc042823          	sw	zero,-48(s0)
  14:	fc040a23          	sb	zero,-44(s0)

    if(pipe(fd) == -1)
  18:	fe840513          	addi	a0,s0,-24
  1c:	00000097          	auipc	ra,0x0
  20:	39e080e7          	jalr	926(ra) # 3ba <pipe>
  24:	57fd                	li	a5,-1
  26:	06f50d63          	beq	a0,a5,a0 <main+0xa0>
  ...
  2e:	378080e7          	jalr	888(ra) # 3a2 <fork>

    if(pid == 0) //子进程
  32:	c551                	beqz	a0,be <main+0xbe>
        printf("%d: received %s\n", getpid(), ping_buf);
        //close(pong_pipe[1]);
        //close(ping_pipe[0]);
        exit(0);
  ...
  34:	0ea05363          	blez	a0,11a <main+0x11a>
    {
        write(fd[1], "ping", 5);
  38:	4615                	li	a2,5
  3a:	00001597          	auipc	a1,0x1
  3e:	8be58593          	addi	a1,a1,-1858 # 8f8 <malloc+0x118>
  42:	fec42503          	lw	a0,-20(s0)
  46:	00000097          	auipc	ra,0x0
  4a:	384080e7          	jalr	900(ra) # 3ca <write>
        close(fd[1]);
  4e:	fec42503          	lw	a0,-20(s0)
  52:	00000097          	auipc	ra,0x0
  56:	380080e7          	jalr	896(ra) # 3d2 <close>
        //close(pong_pipe[1]);
        //close(ping_pipe[0]);
        wait(&status);
  5a:	fe440513          	addi	a0,s0,-28
  5e:	00000097          	auipc	ra,0x0
  62:	354080e7          	jalr	852(ra) # 3b2 <wait>
        read(fd[0], pong_buf, 5);
  66:	4615                	li	a2,5
  68:	fd040593          	addi	a1,s0,-48
  6c:	fe842503          	lw	a0,-24(s0)
  70:	00000097          	auipc	ra,0x0
  74:	352080e7          	jalr	850(ra) # 3c2 <read>
        printf("%d: received %s\n", getpid(), pong_buf);
  78:	00000097          	auipc	ra,0x0
  7c:	3b2080e7          	jalr	946(ra) # 42a <getpid>
  80:	85aa                	mv	a1,a0
  82:	fd040613          	addi	a2,s0,-48
  86:	00001517          	auipc	a0,0x1
  8a:	85a50513          	addi	a0,a0,-1958 # 8e0 <malloc+0x100>
  8e:	00000097          	auipc	ra,0x0
  92:	694080e7          	jalr	1684(ra) # 722 <printf>
        exit(0);
  96:	4501                	li	a0,0
  98:	00000097          	auipc	ra,0x0
  9c:	312080e7          	jalr	786(ra) # 3aa <exit>
        write(2, "pipe error!\n", 13);
  a0:	4635                	li	a2,13
  a2:	00001597          	auipc	a1,0x1
  a6:	82658593          	addi	a1,a1,-2010 # 8c8 <malloc+0xe8>
  aa:	4509                	li	a0,2
  ...
  ba:	2f4080e7          	jalr	756(ra) # 3aa <exit>
        write(fd[1], "pong", 5);
  be:	4615                	li	a2,5
  c0:	00001597          	auipc	a1,0x1
  c4:	81858593          	addi	a1,a1,-2024 # 8d8 <malloc+0xf8>
  c8:	fec42503          	lw	a0,-20(s0)
  cc:	00000097          	auipc	ra,0x0
  d0:	2fe080e7          	jalr	766(ra) # 3ca <write>
        close(fd[1]);
  d4:	fec42503          	lw	a0,-20(s0)
  d8:	00000097          	auipc	ra,0x0
  dc:	2fa080e7          	jalr	762(ra) # 3d2 <close>
        read(fd[0], ping_buf, 5);    
  e0:	4615                	li	a2,5
  e2:	fd840593          	addi	a1,s0,-40
  e6:	fe842503          	lw	a0,-24(s0)
  ea:	00000097          	auipc	ra,0x0
  ee:	2d8080e7          	jalr	728(ra) # 3c2 <read>
        printf("%d: received %s\n", getpid(), ping_buf);
  f2:	00000097          	auipc	ra,0x0
  f6:	338080e7          	jalr	824(ra) # 42a <getpid>
  fa:	85aa                	mv	a1,a0
  fc:	fd840613          	addi	a2,s0,-40
 100:	00000517          	auipc	a0,0x0
 104:	7e050513          	addi	a0,a0,2016 # 8e0 <malloc+0x100>
 108:	00000097          	auipc	ra,0x0
 10c:	61a080e7          	jalr	1562(ra) # 722 <printf>
        exit(0);
 110:	4501                	li	a0,0
 ...
 11e:	7e650513          	addi	a0,a0,2022 # 900 <malloc+0x120>
 122:	00000097          	auipc	ra,0x0
 126:	600080e7          	jalr	1536(ra) # 722 <printf>
        exit(1);
 12a:	4505                	li	a0,1
